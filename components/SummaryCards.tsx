...
function MetricCard({ label, value, isPercent = false, isPositive, icon, accentVar, delay = 0 }: {
  ...
  return (
    <div
      className="animate-fadeIn card relative overflow-hidden p-5 cursor-default select-none"
    ...
    >
      {/* Ambient corner glow */}
      <div className="absolute -top-8 -right-8 w-24 h-24 rounded-full pointer-events-none blur-2xl opacity-30"
