...
interface NavigationProps {
  ...
  activeTab?: 'dashboard' | 'stock-analytics' | 'stock-research' | 'predictions' | 'world-economy';
  onTabChange?: (tab: 'dashboard' | 'stock-analytics' | 'stock-research' | 'predictions' | 'world-economy') => void;
}
